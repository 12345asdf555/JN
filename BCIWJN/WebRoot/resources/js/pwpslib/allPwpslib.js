...
//				str += '<a id="wpslibgive" class="easyui-linkbutton" href="javascript:selectMainWps('+row.fid+','+row.manu+')"/>';
				...
				str += '<a id="wpsliboutputpwps" class="easyui-linkbutton" href="wps/outputWpslibpwps?id='+row.fid+'"/>';
				str += '<a id="generatePwps" class="easyui-linkbutton" href="javascript:openTaskDialog()"/>';
				return str;
			}
		}] ],
		pagination : true,
		...
		onExpandRow: function(index,row){
			...
			if(row.manu==149){
				ddv.datagrid({
					...
					pageSize : 10,
					pageList : [ 10, 20, 30, 40, 50 ],
					url : "wps/getMainpwpsList?fwpslib_id="+row.fid,
					rownumbers : true,
					pagination : true,
					showPageList : false,
					singleSelect : true,
				...
				ddv.datagrid({
					...
					pageSize : 30,
					pageList : [ 10, 20, 30, 40, 50 ],
					url : "wps/getMainpwpsList?parent="+row.fid,
					singleSelect : true,
					rownumbers : true,
					showPageList : false,
					columns : [ [ { 
